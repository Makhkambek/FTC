...
public class RobotControlMechanum {
    ...
    public void initialize(){
        robotHardwareMap.rearLeftMotor.setDirection(DcMotorSimple.Direction.REVERSE);
        robotHardwareMap.rearRightMotor.setDirection(DcMotorSimple.Direction.FORWARD); //on bucky this is reverse
    ...
    public void teleOpMechanum(double drive, double strafe, double twist){
        ...
        robotHardwareMap.rearLeftMotor.setPower(speeds[2]);
        robotHardwareMap.rearRightMotor.setPower(speeds[3]);
    }
    ...
    public void strafe(double dist_Strafe_In, LinearDirection dir, double power, double timeoutS, LinearOpMode theOpMode, boolean nearest90){
        ...
        robotHardwareMap.rearLeftMotor.setZeroPowerBehavior(DcMotor.ZeroPowerBehavior.FLOAT);
        robotHardwareMap.frontLeftMotor.setZeroPowerBehavior(DcMotor.ZeroPowerBehavior.FLOAT);
        robotHardwareMap.rearRightMotor.setZeroPowerBehavior(DcMotor.ZeroPowerBehavior.FLOAT);
        robotHardwareMap.frontRightMotor.setZeroPowerBehavior(DcMotor.ZeroPowerBehavior.FLOAT);

        // Reset the encoders
        robotHardwareMap.rearLeftMotor.setMode(DcMotor.RunMode.STOP_AND_RESET_ENCODER);
        robotHardwareMap.frontLeftMotor.setMode(DcMotor.RunMode.STOP_AND_RESET_ENCODER);
        robotHardwareMap.rearRightMotor.setMode(DcMotor.RunMode.STOP_AND_RESET_ENCODER);
        ...
        robotHardwareMap.rearLeftMotor.setTargetPosition(newStrafeLeftFTarget);
        robotHardwareMap.frontLeftMotor.setTargetPosition(newStrafeRightFTarget);
        robotHardwareMap.rearRightMotor.setTargetPosition(newStrafeLeftBTarget);
        robotHardwareMap.frontRightMotor.setTargetPosition(newStrafeRightBTarget);

        //Set the motors to run to encoder mode
        robotHardwareMap.rearLeftMotor.setMode(DcMotor.RunMode.RUN_TO_POSITION);
        robotHardwareMap.frontLeftMotor.setMode(DcMotor.RunMode.RUN_TO_POSITION);
        robotHardwareMap.rearRightMotor.setMode(DcMotor.RunMode.RUN_TO_POSITION);
        ...
        while ((runtime.seconds() < timeoutS)
                && (robotHardwareMap.rearLeftMotor.isBusy())
...
*/
        ...
        robotHardwareMap.rearLeftMotor.setMode(DcMotor.RunMode.RUN_WITHOUT_ENCODER);
        robotHardwareMap.frontLeftMotor.setMode(DcMotor.RunMode.RUN_WITHOUT_ENCODER);
        robotHardwareMap.rearRightMotor.setMode(DcMotor.RunMode.RUN_WITHOUT_ENCODER);
    ...
    protected void setMotorPowerForLinearMove(double LF, double RF, double RR, double LR) {
        ...
        robotHardwareMap.rearRightMotor.setPower(RR);
        robotHardwareMap.rearLeftMotor.setPower(LR);
    }
