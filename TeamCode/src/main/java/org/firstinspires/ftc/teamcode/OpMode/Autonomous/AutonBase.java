...
import org.firstinspires.ftc.teamcode.OpMode.hardware.RobotGlobalSettings;
...
//        flipper = new RobotControlFlipperMotor(theHardwareMap, this);
        ...
        theHardwareMap.rearLeftMotor.setDirection(DcMotorSimple.Direction.REVERSE);
        theHardwareMap.rearRightMotor.setDirection(DcMotorSimple.Direction.FORWARD);
        ...
        theHardwareMap.rearLeftMotor.setMode(DcMotor.RunMode.STOP_AND_RESET_ENCODER);
        theHardwareMap.rearRightMotor.setMode(DcMotor.RunMode.STOP_AND_RESET_ENCODER);

        theHardwareMap.rearLeftMotor.setZeroPowerBehavior(DcMotor.ZeroPowerBehavior.BRAKE);
        ...
        theHardwareMap.rearRightMotor.setZeroPowerBehavior(DcMotor.ZeroPowerBehavior.BRAKE);
        ...
        theHardwareMap.rearLeftMotor.setMode(DcMotor.RunMode.RUN_USING_ENCODER);
        theHardwareMap.rearRightMotor.setMode(DcMotor.RunMode.RUN_USING_ENCODER);
    ...
    public void encoderDrive (double speed, double inches, double timeoutS) {
        ...
        if (opModeIsActive()) {
            ...
            newBackLeftTarget = theHardwareMap.rearLeftMotor.getCurrentPosition() + (int)(inches * RobotGlobalSettings.COUNTS_PER_INCH);
            newFrontRightTarget = theHardwareMap.frontRightMotor.getCurrentPosition() + (int)(inches * RobotGlobalSettings.COUNTS_PER_INCH);
            newBackRightTarget = theHardwareMap.rearRightMotor.getCurrentPosition() + (int)(inches * RobotGlobalSettings.COUNTS_PER_INCH);

            theHardwareMap.frontLeftMotor.setTargetPosition(newFrontLeftTarget);
            theHardwareMap.rearLeftMotor.setTargetPosition(newBackLeftTarget);
            theHardwareMap.frontRightMotor.setTargetPosition(newFrontRightTarget);
            theHardwareMap.rearRightMotor.setTargetPosition(newBackRightTarget);

            // Turn On RUN_TO_POSITION
            theHardwareMap.frontLeftMotor.setMode(DcMotor.RunMode.RUN_TO_POSITION);
            theHardwareMap.rearLeftMotor.setMode(DcMotor.RunMode.RUN_TO_POSITION);
            theHardwareMap.frontRightMotor.setMode(DcMotor.RunMode.RUN_TO_POSITION);
            theHardwareMap.rearRightMotor.setMode(DcMotor.RunMode.RUN_TO_POSITION);

            // reset the timeout time and start motion.
            runtime.reset();
            theHardwareMap.frontLeftMotor.setPower(Math.abs(speed));
            theHardwareMap.rearLeftMotor.setPower(Math.abs(speed));
            theHardwareMap.frontRightMotor.setPower(Math.abs(speed));
            theHardwareMap.rearRightMotor.setPower(Math.abs(speed));

            while (opModeIsActive() &&
                    (runtime.seconds() < timeoutS) &&
                    (theHardwareMap.frontLeftMotor.isBusy() && theHardwareMap.rearLeftMotor.isBusy()
                            && theHardwareMap.frontRightMotor.isBusy() && theHardwareMap.rearRightMotor.isBusy())) {
                ...
                telemetry.addData("Currently at",  " at %7d :%7d :%7d :%7d",
                        theHardwareMap.frontLeftMotor.getCurrentPosition(), theHardwareMap.rearLeftMotor.getCurrentPosition(),
                        theHardwareMap.frontRightMotor.getCurrentPosition(), theHardwareMap.rearRightMotor.getCurrentPosition());
                telemetry.update();
            }

            theHardwareMap.frontLeftMotor.setPower(0);
            theHardwareMap.rearLeftMotor.setPower(0);
            theHardwareMap.frontRightMotor.setPower(0);
            theHardwareMap.rearRightMotor.setPower(0);
    ...
    public void imuDrive(double maxDriveSpeed,
        ...
        if (opModeIsActive()) {
            ...
            leftRearTarget = theHardwareMap.rearLeftMotor.getCurrentPosition() + moveCounts;
            rightRearTarget = theHardwareMap.rearRightMotor.getCurrentPosition() + moveCounts;
            ...
            theHardwareMap.rearLeftMotor.setTargetPosition(leftRearTarget);
            theHardwareMap.rearRightMotor.setTargetPosition(rightRearTarget);
            ...
            while (opModeIsActive() &&
                    (theHardwareMap.rearLeftMotor.isBusy() && theHardwareMap.rearRightMotor.isBusy()&&
...
//            telemetry.addData("Arm ENcoder; ", armMotor.getArmEncodedPosition());
    ...
    public void encoderStrafe(double speed, double strafeDistance, double timeoutS){
        ...
        if (opModeIsActive()){
            ...
            newBackLeftTarget = theHardwareMap.rearLeftMotor.getCurrentPosition() + (int)(-strafeDistance * COUNTS_PER_INCH);
            newFrontRightTarget = theHardwareMap.frontRightMotor.getCurrentPosition() + (int)(-strafeDistance * COUNTS_PER_INCH);
            newBackRightTarget = theHardwareMap.rearRightMotor.getCurrentPosition() + (int)(strafeDistance * COUNTS_PER_INCH);
    ...
    private void moveRobot(double drive, double turn) {
        ...
        theHardwareMap.rearLeftMotor.setPower(leftSpeed);
        theHardwareMap.rearRightMotor.setPower(rightSpeed);
