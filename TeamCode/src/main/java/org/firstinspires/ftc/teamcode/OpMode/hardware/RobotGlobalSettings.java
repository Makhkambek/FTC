...
*/
    ...
    public static double COUNTS_PER_MOTOR_REV =      537.7; ///< The number of encoder counts per output shaft revolution for 5202-0002-0019 GoBilda motor
    ...
    public static String dataServerHostIP = "192.168.43.1";
    public static int dataServerHostPort = 5555;
